    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            fastify.post('/auth/login', {
                ...
                var _a, email, password, user, isValidPassword, tokenPayload, token, userResponse, error_1;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 2:
                            ...
                            token = jsonwebtoken_1.default.sign(tokenPayload, JWT_SECRET, { expiresIn: '7d' });
                            userResponse = {
                                id: user.id,
                                email: user.email,
                                name: user.name,
                        ...
                        case 4:
                            error_1 = _b.sent();
                            fastify.log.error('Login error:', error_1);
            ...
            fastify.get('/auth/me', {
                ...
                var authHeader, token, decoded, user, jwtError_1, error_2;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 5, , 6]);
                        ...
                        case 5:
                            error_2 = _a.sent();
                            fastify.log.error('Get user profile error:', error_2);
                            return [2 /*return*/, reply.code(500).send({
                                    success: false,
                                    message: 'Internal server error'
                                })];
