...
module.exports = (0, fastify_plugin_1.default)(function (fastify) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fastify.register(require('@fastify/rate-limit'), {
                        ...
                        errorResponseBuilder: function (request, context) {
                            return {
                                ...
                                message: "Rate limit exceeded. Try again in ".concat(Math.round(context.ttl / 1000), " seconds."),
                                date: Date.now(),
                                expiresIn: Math.round(context.ttl / 1000),
                            };
                        },
                        onExceeding: function (request, key) {
                            fastify.log.warn("Rate limit exceeded for ".concat(key));
                        },
                        onExceeded: function (request, key) {
                            fastify.log.error("Rate limit exceeded for ".concat(key));
                        },
                    })];
                case 1:
                    _a.sent();
